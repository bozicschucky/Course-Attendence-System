...
public interface CourseOfferingRepository extends JpaRepository<CourseOffering, Long> {
    ...
    @Query("SELECT new com.chucky.school.Adaptor.CourseOfferingDetailsDTO(co.id, co.course.id, co.faculty.id, co.capacity, co.courseOfferingType, co.room, co.startDate, co.endDate) FROM CourseOffering co")
    List<CourseOfferingDetailsDTO> getCourseOfferingDetails();

    @Query("SELECT new com.chucky.school.Adaptor.CourseOfferingDetailsDTO(co.id, co.course.id, co.faculty.id, co.capacity, co.courseOfferingType, co.room, co.startDate, co.endDate) FROM CourseOffering co where co.id=:courseOfferingId")
